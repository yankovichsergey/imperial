...
export class QuestionSheetResourceConstants {
    ...
    public static SITES = `https://graph.microsoft.com/v1.0/me/drives/${environment.driveId}/items/{sheetId}/workbook/worksheets/Branches/range(address='A2:E7000')?$select=values`;
    public static CUSTOMERS = `https://graph.microsoft.com/v1.0/me/drives/${environment.driveId}/items/{sheetId}/workbook/worksheets/{sheetName}/range(address='D2:H7000')?$select=values`;
    public static LOCATIONS = `https://graph.microsoft.com/v1.0/me/drives/${environment.driveId}/items/{sheetId}/workbook/worksheets/{sheetName}/range(address='E2:L7000')?$select=values`;
